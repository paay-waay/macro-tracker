...
const CACHE=PREFIX+'3.2.2-r1';
const FILES=['./','index.html','styles-3.2.2.css','core-3.1.0.js','storage-3.1.0.js','app-3.2.2.js','manifest.json','icon-192.png','icon-512.png','apple-touch-icon.png'];
